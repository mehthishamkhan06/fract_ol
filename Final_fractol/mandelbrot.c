...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/11/18 16:09:56 by mohkhan           #+#    #+#             */
/*   Updated: 2024/11/18 16:09:57 by mohkhan          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static	void	handle_pixel(int x, int y, t_fractal *fractal)
{
	...
	z.re = 0.0;
	z.im = 0.0;
	c.re = (map(x, -2, +2, WIDTH) * fractal->view) + fractal->x_offset;
	c.im = (map(y, +2, -2, HEIGHT) * fractal->view) + fractal->y_offset;
